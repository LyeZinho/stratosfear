 ...
 * 15 geopolitical factions with market profiles, AI personalities, and terrain multipliers
 */
...
export const TERRAIN_DAMAGE_MULTIPLIERS: Record<string, TerrainMultiplierData> = {
  ...
  MILITARY_BASE_ENEMY: { multiplier: 20.0, pilotSurvival: 0.05, costDescription: 'Combat' },
  MILITARY_BASE_FRIENDLY: { multiplier: 1.0, pilotSurvival: 0.95, costDescription: 'Protocol' },
